  ...
  <div class="w-full">
    <div class="w-full hidden lg:flex flex-col items-center">
      <nav class="w-full flex justify-center mt-4">
        <ul class="w-full flex justify-center">
          <li><button ref="nav-0" style="background-image: url('/img/video.png');" class="mx-6 w-40 h-40 bg-contain bg-no-repeat bg-center outline-none" @click="expand(0)"></button></li>
          <li><button ref="nav-1" style="background-image: url('/img/design.png');" class="mx-6 w-40 h-40 bg-contain bg-no-repeat bg-center outline-none" @click="expand(1)"></button></li>
          <li><button ref="nav-2" style="background-image: url('/img/mockup.png');" class="mx-6 w-40 h-40 bg-contain bg-no-repeat bg-center outline-none" @click="expand(2)"></button></li>
        </ul>
      </nav>
      <div ref="container" class="bg-gray-accent rounded-3xl w-full xl:w-3/4 mt-10 z-10 min-h-80 relative py-5">
        ...
        <div ref="content-0" class="w-full text-center">
          <h4 class="font-content-heading text-4xl mb-6">Video Production</h4>
          <div class="flex justify-center items-center">
            <div class="flex-1">
              <p class="font-content text-4xl">Tools</p>
              <ul class="content-paragraph font-content list-inside text-xl">
                <li><a href="https://www.adobe.com/products/premiere.html" target="_blank">Premiere Pro</a></li>
                <li><a href="https://www.adobe.com/products/aftereffects.html" target="_blank">After Effects</a></li>
              </ul>
            </div>
        ...
        <div ref="content-1" style="display: none;" class="w-full text-center">
          <h4 class="font-content-heading text-4xl mb-6">Graphic Design</h4>
          <div class="flex justify-center items-center">
            <div class="flex-1">
              <p class="font-content text-4xl">Tools</p>
              <ul class="content-paragraph font-content list-inside text-xl">
                <li><a href="https://www.adobe.com/products/photoshop.html" target="_blank">Photoshop</a></li>
                <li><a href="https://gimp.org" target="_blank">GIMP</a></li>
                <li><a href="https://www.adobe.com/products/illustrator.html" target="_blank">Illustrator</a></li>
              </ul>
            </div>
            <div class="h-40 bg-accent-teal w-1 rounded-3xl"></div>
            <div class="mx-20">
              <p class="font-content text-6xl">4 years</p>
              <p class="font-content text-2xl">of experience</p>
            </div>
            <div class="h-40 bg-accent-teal w-1 rounded-3xl"></div>
            <div class="flex-1">
        ...
        <div ref="content-2" style="display: none;" class="w-full text-center">
          <h4 class="font-content-heading text-4xl mb-6">Layout &amp; Mockup Design</h4>
          <div class="flex justify-center items-center">
            <div class="flex-1">
              <p class="font-content text-4xl">Tools</p>
              <ul class="content-paragraph font-content list-inside text-xl">
                <li><a href="https://www.adobe.com/products/xd.html" target="_blank">XD</a></li>
                <li><a href="https://www.adobe.com/products/photoshop.html" target="_blank">Photoshop</a></li>
              </ul>
            </div>
            <div class="h-40 bg-accent-teal w-1 rounded-3xl"></div>
            <div class="mx-20">
              <p class="font-content text-6xl">6 months</p>
              <p class="font-content text-2xl">of experience</p>
            </div>
            <div class="h-40 bg-accent-teal w-1 rounded-3xl"></div>
            <div class="flex-1">
    ...
    <ul class="w-full flex flex-wrap lg:hidden">
      <li class="full inline-flex flex-wrap min-h-20">
        <div class="mr-5 flex justify-center w-20 h-20 text-center"><img src="/img/video.png" alt="Video Production" class="w-full object-contain"></div>
        <div class="flex-1">
          <h1 class="text-2xl">Video Production</h1>
          <p class="my-2 font-content text-lg mr-3">3 months of experience</p>
          <p class="my-2 font-content text-lg mr-3">Tools used:</p>
      ...
      <li class="full inline-flex flex-wrap min-h-20">
        <div class="mr-5 flex justify-center w-20 h-20 text-center"><img src="/img/design.png" alt="Graphic Design" class="w-full object-contain"></div>
        <div class="flex-1">
          <h1 class="text-2xl">Graphic Design</h1>
          <p class="my-2 font-content text-lg mr-3">4 years of experience</p>
          <p class="my-2 font-content text-lg mr-3">Tools used:</p>
          <ul class="content-paragraph font-content list-inside list-disc text-lg mr-3">
            <li><a href="https://www.adobe.com/products/photoshop.html" target="_blank">Photoshop</a></li>
            <li><a href="https://gimp.org" target="_blank">GIMP</a></li>
      ...
      <li class="w-5/6 mx-auto my-8"><hr class="secondary-rule border-none"></li>
      <li class="full inline-flex flex-wrap min-h-20">
        <div class="mr-5 flex justify-center w-20 h-20 text-center"><img src="/img/mockup.png" alt="Layout and Mockup Design" class="w-full object-contain"></div>
        <div class="flex-1">
          <h1 class="text-2xl">Layout &amp; Mockup Design</h1>
          <p class="my-2 font-content text-lg mr-3">6 months of experience</p>
          <p class="my-2 font-content text-lg mr-3">Tools used:</p>
          <ul class="content-paragraph font-content list-inside list-disc text-lg mr-3">
            <li><a href="https://www.adobe.com/products/xd.html" target="_blank">XD</a></li>
            <li><a href="https://www.adobe.com/products/photoshop.html" target="_blank">Photoshop</a></li>
